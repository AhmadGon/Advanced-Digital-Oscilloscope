// Nios_SDRAM_COM_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module Nios_SDRAM_COM_mm_interconnect_0 (
	...
	wire  [18:0] systemid_control_slave_agent_m0_address;                                      // SystemID_control_slave_agent:m0_address -> SystemID_control_slave_translator:uav_address
	...
	wire  [95:0] systemid_control_slave_agent_rf_source_data;                                  // SystemID_control_slave_agent:rf_source_data -> SystemID_control_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] systemid_control_slave_agent_rsp_fifo_out_data;                               // SystemID_control_slave_agent_rsp_fifo:out_data -> SystemID_control_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                         // cmd_mux_001:src_data -> SystemID_control_slave_agent:cp_data
	...
	wire  [18:0] pll_pll_slave_agent_m0_address;                                               // PLL_pll_slave_agent:m0_address -> PLL_pll_slave_translator:uav_address
	...
	wire  [94:0] cmd_mux_005_src_data;                                                         // cmd_mux_005:src_data -> DATA_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                        // DATA_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                      // cmd_mux_005:src_channel -> DATA_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_006_src_data;                                                         // cmd_mux_006:src_data -> Address_s1_agent:cp_data
	...
	wire  [18:0] event_register_s1_agent_m0_address;                                           // Event_Register_s1_agent:m0_address -> Event_Register_s1_translator:uav_address
	...
	wire  [95:0] event_register_s1_agent_rf_source_data;                                       // Event_Register_s1_agent:rf_source_data -> Event_Register_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] event_register_s1_agent_rsp_fifo_out_data;                                    // Event_Register_s1_agent_rsp_fifo:out_data -> Event_Register_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                        // cmd_mux_007:src_valid -> Event_Register_s1_agent:cp_valid
	wire  [94:0] cmd_mux_007_src_data;                                                         // cmd_mux_007:src_data -> Event_Register_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                        // Event_Register_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                      // cmd_mux_007:src_channel -> Event_Register_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                // cmd_mux_007:src_startofpacket -> Event_Register_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                  // cmd_mux_007:src_endofpacket -> Event_Register_s1_agent:cp_endofpacket
	...
	wire  [94:0] systemid_control_slave_agent_rp_data;                                         // SystemID_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] data_s1_agent_rp_data;                                                        // DATA_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [94:0] address_s1_agent_rp_data;                                                     // Address_s1_agent:rp_data -> router_008:sink_data
	...
	wire         event_register_s1_agent_rp_valid;                                             // Event_Register_s1_agent:rp_valid -> router_009:sink_valid
	wire  [94:0] event_register_s1_agent_rp_data;                                              // Event_Register_s1_agent:rp_data -> router_009:sink_data
	wire         event_register_s1_agent_rp_ready;                                             // router_009:sink_ready -> Event_Register_s1_agent:rp_ready
	wire         event_register_s1_agent_rp_startofpacket;                                     // Event_Register_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         event_register_s1_agent_rp_endofpacket;                                       // Event_Register_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [94:0] router_src_data;                                                              // router:src_data -> NiosII_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                             // NiosII_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [7:0] router_src_channel;                                                           // router:src_channel -> NiosII_data_master_limiter:cmd_sink_channel
	...
	wire  [94:0] niosii_data_master_limiter_cmd_src_data;                                      // NiosII_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         niosii_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> NiosII_data_master_limiter:cmd_src_ready
	wire   [7:0] niosii_data_master_limiter_cmd_src_channel;                                   // NiosII_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [94:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> NiosII_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                            // NiosII_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [7:0] rsp_mux_src_channel;                                                          // rsp_mux:src_channel -> NiosII_data_master_limiter:rsp_sink_channel
	...
	wire  [94:0] niosii_data_master_limiter_rsp_src_data;                                      // NiosII_data_master_limiter:rsp_src_data -> NiosII_data_master_agent:rp_data
	wire         niosii_data_master_limiter_rsp_src_ready;                                     // NiosII_data_master_agent:rp_ready -> NiosII_data_master_limiter:rsp_src_ready
	wire   [7:0] niosii_data_master_limiter_rsp_src_channel;                                   // NiosII_data_master_limiter:rsp_src_channel -> NiosII_data_master_agent:rp_channel
	...
	wire  [94:0] router_001_src_data;                                                          // router_001:src_data -> NiosII_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                         // NiosII_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [7:0] router_001_src_channel;                                                       // router_001:src_channel -> NiosII_instruction_master_limiter:cmd_sink_channel
	...
	wire  [94:0] niosii_instruction_master_limiter_cmd_src_data;                               // NiosII_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [7:0] niosii_instruction_master_limiter_cmd_src_channel;                            // NiosII_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [94:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> NiosII_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                        // NiosII_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [7:0] rsp_mux_001_src_channel;                                                      // rsp_mux_001:src_channel -> NiosII_instruction_master_limiter:rsp_sink_channel
	...
	wire  [94:0] niosii_instruction_master_limiter_rsp_src_data;                               // NiosII_instruction_master_limiter:rsp_src_data -> NiosII_instruction_master_agent:rp_data
	...
	wire   [7:0] niosii_instruction_master_limiter_rsp_src_channel;                            // NiosII_instruction_master_limiter:rsp_src_channel -> NiosII_instruction_master_agent:rp_channel
	...
	wire   [7:0] niosii_data_master_limiter_cmd_valid_data;                                    // NiosII_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [7:0] niosii_instruction_master_limiter_cmd_valid_data;                             // NiosII_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         event_register_s1_agent_rdata_fifo_src_valid;                                 // Event_Register_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] event_register_s1_agent_rdata_fifo_src_data;                                  // Event_Register_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         event_register_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_007:in_0_ready -> Event_Register_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                            // avalon_st_adapter_007:out_0_valid -> Event_Register_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                             // avalon_st_adapter_007:out_0_data -> Event_Register_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                            // Event_Register_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                            // avalon_st_adapter_007:out_0_error -> Event_Register_s1_agent:rdata_fifo_sink_error
	...
	Nios_SDRAM_COM_mm_interconnect_0_router router (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_001 router_001 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_002 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_003 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_004 router_004 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_005 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_004 router_006 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_007 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_008 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_router_002 router_009 (
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (PLL_c0_clk),                                       //        clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (PLL_c0_clk),                                              //        clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                         //       clk.clk
		.reset               (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                         //       clk.clk
		.reset              (PLL_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (PLL_c0_clk),                               //       clk.clk
		.reset              (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (PLL_c0_clk),                               //       clk.clk
		.reset               (NiosII_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios_SDRAM_COM_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
