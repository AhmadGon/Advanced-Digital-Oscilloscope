...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Nios_Screen_Reader.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Nios_Screen_Reader
SOPC_NAME := Nios_Screen_Reader
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001060
SOPC_SYSID_FLAG += --sidp=0x10001060
ELF_PATCH_FLAG  += --sidp 0x10001060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1597418486
SOPC_SYSID_FLAG += --timestamp=1597418486
ELF_PATCH_FLAG  += --timestamp 1597418486
